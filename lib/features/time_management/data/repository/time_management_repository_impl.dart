...
import 'package:linchpin/features/time_management/data/models/start_end_work.dart';
...
class TimeManagementRepositoryImpl extends TimeManagementRepository {
  ...
  TimeManagementRepositoryImpl(this.apiTimeMamagement, this.apiStartEndWork);
  @override
  ...
  Future<DataState<StartEndWorkEntity>> startEndWork() async {
    try {
      Response response = await apiStartEndWork.startEndWork();
      StartEndWorkEntity startEndWork =
          StartEndWorkModel.fromJson(response.data);
      return DataSuccess(startEndWork);
    } on DioException catch (e) {
      return await handleError(e);
    }
  }
